...
struct tl_ds_chat_full *fetch_ds_constructor_chat_full_l27 (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xa9d0662f && T->type->name != 0x562f99d0)) { return 0; }
  struct tl_ds_chat_full *  result = talloc0 (sizeof (*result));
  result->magic = 0x630e61be;
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
    .params = 0,
...
struct tl_ds_dc_option *fetch_ds_constructor_dc_option (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x2ec2a43c && T->type->name != 0xd13d5bc3)) { return 0; }
...
struct tl_ds_decrypted_message_media *fetch_ds_constructor_decrypted_message_media_external_document (struct paramed_type *T) {
  ...
  &(struct paramed_type){
    ...
    .params = (struct paramed_type *[]){
      &(struct paramed_type){
        .type = &(struct tl_type_descr) {.name = 0xad9354a1, .id = "DocumentAttribute", .params_num = 0, .params_types = 0},
        .params = 0,
      },
    }
  };
...
struct tl_ds_document_attribute *fetch_ds_constructor_document_attribute_image_size (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xad9354a1 && T->type->name != 0x526cab5e)) { return 0; }
...
struct tl_ds_message *fetch_ds_constructor_message_empty (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x39c830cb && T->type->name != 0xc637cf34)) { return 0; }
...
struct tl_ds_update *fetch_ds_constructor_update_new_message (struct paramed_type *T) {
  ...
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x39c830cb, .id = "Message", .params_num = 0, .params_types = 0},
    .params = 0,
  };
...
struct tl_ds_updates *fetch_ds_constructor_updates_combined (struct paramed_type *T) {
  ...
  &(struct paramed_type){
    ...
    .params = (struct paramed_type *[]){
      &(struct paramed_type){
        .type = &(struct tl_type_descr) {.name = 0xfe40b697, .id = "User", .params_num = 0, .params_types = 0},
        .params = 0,
      },
    }
  };
...
struct tl_ds_user *fetch_ds_constructor_user_empty (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return 0; }
...
struct tl_ds_user *fetch_ds_constructor_user_self (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return 0; }
  struct tl_ds_user *  result = talloc0 (sizeof (*result));
  result->magic = 0x1c60e608;
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
    .params = 0,
  ...
  result->phone = fetch_ds_type_bare_string (field5);
  struct paramed_type *field6 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x9a486229, .id = "UserProfilePhoto", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  result->photo = fetch_ds_type_user_profile_photo (field6);
  struct paramed_type *field7 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x76de9570, .id = "UserStatus", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  result->status = fetch_ds_type_user_status (field7);
  return result;
}
struct tl_ds_user *fetch_ds_constructor_user_contact (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return 0; }
  struct tl_ds_user *  result = talloc0 (sizeof (*result));
  result->magic = 0xcab35e18;
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
    .params = 0,
  ...
  result->access_hash = fetch_ds_type_bare_long (field5);
  struct paramed_type *field6 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x4ad791db, .id = "Bare_String", .params_num = 0, .params_types = 0},
    .params = 0,
  ...
  result->photo = fetch_ds_type_user_profile_photo (field7);
  struct paramed_type *field8 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x76de9570, .id = "UserStatus", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  result->status = fetch_ds_type_user_status (field8);
  return result;
}
struct tl_ds_user *fetch_ds_constructor_user_request (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return 0; }
  struct tl_ds_user *  result = talloc0 (sizeof (*result));
  result->magic = 0xd9ccc4ef;
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
    .params = 0,
...
struct tl_ds_user *fetch_ds_constructor_user_foreign (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return 0; }
  struct tl_ds_user *  result = talloc0 (sizeof (*result));
  result->magic = 0x075cf7a8;
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
    .params = 0,
...
struct tl_ds_user *fetch_ds_constructor_user_deleted (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return 0; }
  struct tl_ds_user *  result = talloc0 (sizeof (*result));
  result->magic = 0xd6016d7a;
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
    .params = 0,
...
struct tl_ds_user_full *fetch_ds_constructor_user_full (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x771095da && T->type->name != 0x88ef6a25)) { return 0; }
  ...
  result->real_first_name = fetch_ds_type_bare_string (field6);
  struct paramed_type *field7 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x4ad791db, .id = "Bare_String", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  result->real_last_name = fetch_ds_type_bare_string (field7);
  return result;
}
...
struct tl_ds_auth_authorization *fetch_ds_constructor_auth_authorization (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xf6b673a4 && T->type->name != 0x09498c5b)) { return 0; }
...
struct tl_ds_binlog_update *fetch_ds_constructor_binlog_start (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x1af2217e && T->type->name != 0xe50dde81)) { return 0; }
...
struct tl_ds_messages_all_stickers *fetch_ds_constructor_messages_all_stickers_not_modified (struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x348933c1 && T->type->name != 0xcb76cc3e)) { return 0; }
...
struct tl_ds_messages_chat_full *fetch_ds_constructor_messages_chat_full (struct paramed_type *T) {
  ...
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0xa9d0662f, .id = "ChatFull", .params_num = 0, .params_types = 0},
    .params = 0,
  };
...
struct tl_ds_chat_full *fetch_ds_type_chat_full (struct paramed_type *T) {
  ...
  int magic = fetch_int ();
  switch (magic) {
  case 0x630e61be: return fetch_ds_constructor_chat_full_l27 (T); break;
  case 0xcade0791: return fetch_ds_constructor_chat_full (T); break;
  default: assert (0); return NULL;
  }
}
struct tl_ds_chat_full *fetch_ds_type_bare_chat_full (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (skip_constructor_chat_full_l27 (T) >= 0) { in_ptr = save_in_ptr; return fetch_ds_constructor_chat_full_l27 (T); }
...
struct tl_ds_dc_option *fetch_ds_type_dc_option (struct paramed_type *T) {
  ...
  int magic = fetch_int ();
  switch (magic) {
  case 0x2ec2a43c: return fetch_ds_constructor_dc_option (T); break;
  default: assert (0); return NULL;
  }
}
...
struct tl_ds_document_attribute *fetch_ds_type_document_attribute (struct paramed_type *T) {
  ...
  case 0x994c9882: return fetch_ds_constructor_document_attribute_sticker (T); break;
...
struct tl_ds_message *fetch_ds_type_message (struct paramed_type *T) {
  ...
  case 0xa7ab1991: return fetch_ds_constructor_message (T); break;
...
struct tl_ds_user *fetch_ds_type_user (struct paramed_type *T) {
  ...
  case 0x1c60e608: return fetch_ds_constructor_user_self (T); break;
  case 0xcab35e18: return fetch_ds_constructor_user_contact (T); break;
  case 0xd9ccc4ef: return fetch_ds_constructor_user_request (T); break;
  case 0x075cf7a8: return fetch_ds_constructor_user_foreign (T); break;
  case 0xd6016d7a: return fetch_ds_constructor_user_deleted (T); break;
  default: assert (0); return NULL;
  }
}
struct tl_ds_user *fetch_ds_type_bare_user (struct paramed_type *T) {
  ...
  if (skip_constructor_user_self (T) >= 0) { in_ptr = save_in_ptr; return fetch_ds_constructor_user_self (T); }
  if (skip_constructor_user_contact (T) >= 0) { in_ptr = save_in_ptr; return fetch_ds_constructor_user_contact (T); }
  if (skip_constructor_user_request (T) >= 0) { in_ptr = save_in_ptr; return fetch_ds_constructor_user_request (T); }
  if (skip_constructor_user_foreign (T) >= 0) { in_ptr = save_in_ptr; return fetch_ds_constructor_user_foreign (T); }
  if (skip_constructor_user_deleted (T) >= 0) { in_ptr = save_in_ptr; return fetch_ds_constructor_user_deleted (T); }
  assert (0);
  return NULL;
}
struct tl_ds_user_full *fetch_ds_type_user_full (struct paramed_type *T) {
  ...
  int magic = fetch_int ();
  switch (magic) {
  case 0x771095da: return fetch_ds_constructor_user_full (T); break;
  default: assert (0); return NULL;
  }
}
...
struct tl_ds_auth_authorization *fetch_ds_type_auth_authorization (struct paramed_type *T) {
  ...
  int magic = fetch_int ();
  switch (magic) {
  case 0xf6b673a4: return fetch_ds_constructor_auth_authorization (T); break;
  default: assert (0); return NULL;
  }
}
...
struct tl_ds_messages_all_stickers *fetch_ds_type_messages_all_stickers (struct paramed_type *T) {
  ...
  case 0xdcef3102: return fetch_ds_constructor_messages_all_stickers (T); break;
  default: assert (0); return NULL;
  }
}
...
void *fetch_ds_type_any (struct paramed_type *T) {
  ...
  case 0xa9d0662f: return fetch_ds_type_chat_full (T);
  case 0x562f99d0: return fetch_ds_type_bare_chat_full (T);
  ...
  case 0x2ec2a43c: return fetch_ds_type_dc_option (T);
  case 0xd13d5bc3: return fetch_ds_type_bare_dc_option (T);
  ...
  case 0xad9354a1: return fetch_ds_type_document_attribute (T);
  case 0x526cab5e: return fetch_ds_type_bare_document_attribute (T);
  ...
  case 0x39c830cb: return fetch_ds_type_message (T);
  case 0xc637cf34: return fetch_ds_type_bare_message (T);
  ...
  case 0xfe40b697: return fetch_ds_type_user (T);
  case 0x01bf4968: return fetch_ds_type_bare_user (T);
  case 0x771095da: return fetch_ds_type_user_full (T);
  case 0x88ef6a25: return fetch_ds_type_bare_user_full (T);
  ...
  case 0xf6b673a4: return fetch_ds_type_auth_authorization (T);
  case 0x09498c5b: return fetch_ds_type_bare_auth_authorization (T);
  ...
  case 0x1af2217e: return fetch_ds_type_binlog_update (T);
  case 0xe50dde81: return fetch_ds_type_bare_binlog_update (T);
  ...
  case 0x348933c1: return fetch_ds_type_messages_all_stickers (T);
  case 0xcb76cc3e: return fetch_ds_type_bare_messages_all_stickers (T);
