...
int print_ds_constructor_chat_full_l27 (struct tl_ds_chat_full *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xa9d0662f && T->type->name != 0x562f99d0)) { return -1; }
  eprintf (" chatFullL27");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" id :"); }
...
int print_ds_constructor_document_attribute_image_size (struct tl_ds_document_attribute *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xad9354a1 && T->type->name != 0x526cab5e)) { return -1; }
...
int print_ds_constructor_message_empty (struct tl_ds_message *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x39c830cb && T->type->name != 0xc637cf34)) { return -1; }
...
int print_ds_constructor_user_empty (struct tl_ds_user *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return -1; }
  eprintf (" userEmpty");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" id :"); }
...
int print_ds_constructor_user_self (struct tl_ds_user *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return -1; }
  eprintf (" userSelf");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  ...
  print_ds_type_bare_string (DS->phone, field5);
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" photo :"); }
  struct paramed_type *field6 = 
  ...
  print_ds_type_user_profile_photo (DS->photo, field6);
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" status :"); }
  struct paramed_type *field7 = 
  ...
  print_ds_type_user_status (DS->status, field7);
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
int print_ds_constructor_user_contact (struct tl_ds_user *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return -1; }
  eprintf (" userContact");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  ...
  print_ds_type_bare_long (DS->access_hash, field5);
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" phone :"); }
  struct paramed_type *field6 = 
  ...
  print_ds_type_user_profile_photo (DS->photo, field7);
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" status :"); }
  struct paramed_type *field8 = 
  ...
  print_ds_type_user_status (DS->status, field8);
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
int print_ds_constructor_user_request (struct tl_ds_user *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return -1; }
  eprintf (" userRequest");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
...
int print_ds_constructor_user_foreign (struct tl_ds_user *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return -1; }
  eprintf (" userForeign");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
...
int print_ds_constructor_user_deleted (struct tl_ds_user *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return -1; }
  eprintf (" userDeleted");
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
...
int print_ds_constructor_user_full (struct tl_ds_user_full *DS, struct paramed_type *T) {
  ...
  print_ds_type_bare_string (DS->real_first_name, field6);
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  ...
  print_ds_type_bare_string (DS->real_last_name, field7);
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int print_ds_constructor_binlog_start (struct tl_ds_binlog_update *DS, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0x1af2217e && T->type->name != 0xe50dde81)) { return -1; }
...
int print_ds_type_chat_full (struct tl_ds_chat_full *DS, struct paramed_type *T) {
  ...
  eprintf (" (");
  switch (DS->magic) {
  case 0x630e61be: res = print_ds_constructor_chat_full_l27 (DS, T); break;
  case 0xcade0791: res = print_ds_constructor_chat_full (DS, T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int print_ds_type_document_attribute (struct tl_ds_document_attribute *DS, struct paramed_type *T) {
  ...
  case 0x994c9882: res = print_ds_constructor_document_attribute_sticker (DS, T); break;
...
int print_ds_type_message (struct tl_ds_message *DS, struct paramed_type *T) {
  ...
  case 0xa7ab1991: res = print_ds_constructor_message (DS, T); break;
...
int print_ds_type_user (struct tl_ds_user *DS, struct paramed_type *T) {
  ...
  case 0x1c60e608: res = print_ds_constructor_user_self (DS, T); break;
  case 0xcab35e18: res = print_ds_constructor_user_contact (DS, T); break;
  case 0xd9ccc4ef: res = print_ds_constructor_user_request (DS, T); break;
  case 0x075cf7a8: res = print_ds_constructor_user_foreign (DS, T); break;
  case 0xd6016d7a: res = print_ds_constructor_user_deleted (DS, T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int print_ds_type_messages_all_stickers (struct tl_ds_messages_all_stickers *DS, struct paramed_type *T) {
  ...
  case 0xdcef3102: res = print_ds_constructor_messages_all_stickers (DS, T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int print_ds_type_any (void *DS, struct paramed_type *T) {
  ...
  case 0xa9d0662f: return print_ds_type_chat_full (DS, T);
  case 0x562f99d0: return print_ds_type_bare_chat_full (DS, T);
  ...
  case 0x2ec2a43c: return print_ds_type_dc_option (DS, T);
  case 0xd13d5bc3: return print_ds_type_bare_dc_option (DS, T);
  ...
  case 0xad9354a1: return print_ds_type_document_attribute (DS, T);
  case 0x526cab5e: return print_ds_type_bare_document_attribute (DS, T);
  ...
  case 0x39c830cb: return print_ds_type_message (DS, T);
  case 0xc637cf34: return print_ds_type_bare_message (DS, T);
  ...
  case 0xfe40b697: return print_ds_type_user (DS, T);
  case 0x01bf4968: return print_ds_type_bare_user (DS, T);
  case 0x771095da: return print_ds_type_user_full (DS, T);
  case 0x88ef6a25: return print_ds_type_bare_user_full (DS, T);
  ...
  case 0xf6b673a4: return print_ds_type_auth_authorization (DS, T);
  case 0x09498c5b: return print_ds_type_bare_auth_authorization (DS, T);
  ...
  case 0x1af2217e: return print_ds_type_binlog_update (DS, T);
  case 0xe50dde81: return print_ds_type_bare_binlog_update (DS, T);
  ...
  case 0x348933c1: return print_ds_type_messages_all_stickers (DS, T);
  case 0xcb76cc3e: return print_ds_type_bare_messages_all_stickers (DS, T);
