...
int fetch_constructor_chat_full_l27 (struct paramed_type *T) {
...
int fetch_type_chat_full (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x630e61be: res = fetch_constructor_chat_full_l27 (T); break;
  case 0xcade0791: res = fetch_constructor_chat_full (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_chat_full (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_chat_full_l27 (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_chat_full_l27 (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_chat_full (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_chat_full (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_document_attribute (struct paramed_type *T) {
  ...
  case 0x994c9882: res = fetch_constructor_document_attribute_sticker (T); break;
...
int fetch_type_message (struct paramed_type *T) {
  ...
  case 0xa7ab1991: res = fetch_constructor_message (T); break;
...
int fetch_type_user (struct paramed_type *T) {
  ...
  case 0x1c60e608: res = fetch_constructor_user_self (T); break;
...
int fetch_type_any (struct paramed_type *T) {
  ...
  case 0xa9d0662f: return fetch_type_chat_full (T);
  case 0x562f99d0: return fetch_type_bare_chat_full (T);
  ...
  case 0xad9354a1: return fetch_type_document_attribute (T);
  case 0x526cab5e: return fetch_type_bare_document_attribute (T);
  ...
  case 0x39c830cb: return fetch_type_message (T);
  case 0xc637cf34: return fetch_type_bare_message (T);
  ...
  case 0xfe40b697: return fetch_type_user (T);
  case 0x01bf4968: return fetch_type_bare_user (T);
  ...
  case 0x1af2217e: return fetch_type_binlog_update (T);
  case 0xe50dde81: return fetch_type_bare_binlog_update (T);
