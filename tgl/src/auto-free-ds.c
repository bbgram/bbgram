...
void free_ds_constructor_chat_full_l27 (struct tl_ds_chat_full *D, struct paramed_type *T) {
...
void free_ds_constructor_user_self (struct tl_ds_user *D, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return; }
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
  ...
  free_ds_type_string (D->phone, field5);
  struct paramed_type *field6 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x9a486229, .id = "UserProfilePhoto", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  free_ds_type_user_profile_photo (D->photo, field6);
  struct paramed_type *field7 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x76de9570, .id = "UserStatus", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  free_ds_type_user_status (D->status, field7);
}
void free_ds_constructor_user_contact (struct tl_ds_user *D, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return; }
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
  ...
  free_ds_type_long (D->access_hash, field5);
  struct paramed_type *field6 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x4ad791db, .id = "Bare_String", .params_num = 0, .params_types = 0},
    .params = 0,
  ...
  free_ds_type_user_profile_photo (D->photo, field7);
  struct paramed_type *field8 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x76de9570, .id = "UserStatus", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  free_ds_type_user_status (D->status, field8);
}
void free_ds_constructor_user_request (struct tl_ds_user *D, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return; }
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
...
void free_ds_constructor_user_foreign (struct tl_ds_user *D, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return; }
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
...
void free_ds_constructor_user_deleted (struct tl_ds_user *D, struct paramed_type *T) {
  if (ODDP(T) || (T->type->name != 0xfe40b697 && T->type->name != 0x01bf4968)) { return; }
  struct paramed_type *field1 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x57af6425, .id = "Bare_Int", .params_num = 0, .params_types = 0},
...
void free_ds_constructor_user_full (struct tl_ds_user_full *D, struct paramed_type *T) {
  ...
  free_ds_type_string (D->real_first_name, field6);
  struct paramed_type *field7 = 
  &(struct paramed_type){
    .type = &(struct tl_type_descr) {.name = 0x4ad791db, .id = "Bare_String", .params_num = 0, .params_types = 0},
    .params = 0,
  };
  free_ds_type_string (D->real_last_name, field7);
}
...
void free_ds_type_chat_full (struct tl_ds_chat_full *D, struct paramed_type *T) {
  switch (D->magic) {
  case 0x630e61be: free_ds_constructor_chat_full_l27 (D, T); return; 
  case 0xcade0791: free_ds_constructor_chat_full (D, T); return; 
  default: assert (0);
  }
}
...
void free_ds_type_document_attribute (struct tl_ds_document_attribute *D, struct paramed_type *T) {
  ...
  case 0x994c9882: free_ds_constructor_document_attribute_sticker (D, T); return; 
...
void free_ds_type_message (struct tl_ds_message *D, struct paramed_type *T) {
  ...
  case 0xa7ab1991: free_ds_constructor_message (D, T); return; 
...
void free_ds_type_user (struct tl_ds_user *D, struct paramed_type *T) {
  ...
  case 0x1c60e608: free_ds_constructor_user_self (D, T); return; 
  case 0xcab35e18: free_ds_constructor_user_contact (D, T); return; 
  case 0xd9ccc4ef: free_ds_constructor_user_request (D, T); return; 
  case 0x075cf7a8: free_ds_constructor_user_foreign (D, T); return; 
  case 0xd6016d7a: free_ds_constructor_user_deleted (D, T); return; 
  default: assert (0);
  }
}
...
void free_ds_type_messages_all_stickers (struct tl_ds_messages_all_stickers *D, struct paramed_type *T) {
  ...
  case 0xdcef3102: free_ds_constructor_messages_all_stickers (D, T); return; 
  default: assert (0);
  }
}
...
void free_ds_type_any (void *D, struct paramed_type *T) {
  ...
  case 0xa9d0662f: free_ds_type_chat_full (D, T); return;
  case 0x562f99d0: free_ds_type_chat_full (D, T); return;
  ...
  case 0x2ec2a43c: free_ds_type_dc_option (D, T); return;
  case 0xd13d5bc3: free_ds_type_dc_option (D, T); return;
  ...
  case 0xad9354a1: free_ds_type_document_attribute (D, T); return;
  case 0x526cab5e: free_ds_type_document_attribute (D, T); return;
  ...
  case 0x39c830cb: free_ds_type_message (D, T); return;
  case 0xc637cf34: free_ds_type_message (D, T); return;
  ...
  case 0xfe40b697: free_ds_type_user (D, T); return;
  case 0x01bf4968: free_ds_type_user (D, T); return;
  case 0x771095da: free_ds_type_user_full (D, T); return;
  case 0x88ef6a25: free_ds_type_user_full (D, T); return;
  ...
  case 0xf6b673a4: free_ds_type_auth_authorization (D, T); return;
  case 0x09498c5b: free_ds_type_auth_authorization (D, T); return;
  ...
  case 0x1af2217e: free_ds_type_binlog_update (D, T); return;
  case 0xe50dde81: free_ds_type_binlog_update (D, T); return;
  ...
  case 0x348933c1: free_ds_type_messages_all_stickers (D, T); return;
  case 0xcb76cc3e: free_ds_type_messages_all_stickers (D, T); return;
