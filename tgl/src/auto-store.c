...
int store_constructor_chat_full_l27 (struct paramed_type *T) {
...
int store_type_chat_full (struct paramed_type *T) {
  ...
  if (cur_token_len < 0) { return -1; }
  if (cur_token_len < 0) { return -1; }
  if (cur_token_len == 11 && !memcmp (cur_token, "chatFullL27", cur_token_len)) {
    out_int (0x630e61be);
    local_next_token ();
    if (store_constructor_chat_full_l27 (T) < 0) { return -1; }
    expect_token (")", 1);
    return 0;
  }
...
int store_type_any (struct paramed_type *T) {
  ...
  case 0xa9d0662f: return store_type_chat_full (T);
  case 0x562f99d0: return store_type_bare_chat_full (T);
  ...
  case 0xad9354a1: return store_type_document_attribute (T);
  case 0x526cab5e: return store_type_bare_document_attribute (T);
  ...
  case 0x39c830cb: return store_type_message (T);
  case 0xc637cf34: return store_type_bare_message (T);
  ...
  case 0xfe40b697: return store_type_user (T);
  case 0x01bf4968: return store_type_bare_user (T);
  ...
  case 0x1af2217e: return store_type_binlog_update (T);
  case 0xe50dde81: return store_type_bare_binlog_update (T);
