...
int skip_constructor_chat_full_l27 (struct paramed_type *T) {
...
int skip_type_chat_full (struct paramed_type *T) {
  ...
  int magic = fetch_int ();
  switch (magic) {
  case 0x630e61be: return skip_constructor_chat_full_l27 (T);
  case 0xcade0791: return skip_constructor_chat_full (T);
  default: return -1;
  }
}
int skip_type_bare_chat_full (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (skip_constructor_chat_full_l27 (T) >= 0) { return 0; }
  in_ptr = save_in_ptr;
...
int skip_type_document_attribute (struct paramed_type *T) {
  ...
  case 0x994c9882: return skip_constructor_document_attribute_sticker (T);
...
int skip_type_message (struct paramed_type *T) {
  ...
  case 0xa7ab1991: return skip_constructor_message (T);
...
int skip_type_user (struct paramed_type *T) {
  ...
  case 0x1c60e608: return skip_constructor_user_self (T);
...
int skip_type_any (struct paramed_type *T) {
  ...
  case 0xa9d0662f: return skip_type_chat_full (T);
  case 0x562f99d0: return skip_type_bare_chat_full (T);
  ...
  case 0xad9354a1: return skip_type_document_attribute (T);
  case 0x526cab5e: return skip_type_bare_document_attribute (T);
  ...
  case 0x39c830cb: return skip_type_message (T);
  case 0xc637cf34: return skip_type_bare_message (T);
  ...
  case 0xfe40b697: return skip_type_user (T);
  case 0x01bf4968: return skip_type_bare_user (T);
  ...
  case 0x1af2217e: return skip_type_binlog_update (T);
  case 0xe50dde81: return skip_type_bare_binlog_update (T);
